    ...
    <app-layout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg flex blocoGeral">
                    ...
                    <div class="w-3/12 bg-gray-200 bg-opacity-25 border-r border-gray-200 overflow-y-scroll">
                        <ul>
                            <li 
                                ...
                                class="p-6 text-lg text-gray-600 leading-7 font-semibold border-b hover:bg-gray-200 border-gray-200 hover:bg-opacity-50 hover:cursor-pointer">
                        ...
                        <div class="w-full p-6 flex flex-col overflow-y-scroll">
                            <div 
                                ...
                                <p 
                                    ...
                                    class="inline-block p-2 rounded-md larguraMaxima">
                                    {{ message.content }}
                                </p>
                        ...
                        <div v-if="userActive" class="w-full bg-gray-200 bg-opacity-25 p-6 border-t border-gray-200">
                            <form v-on:submit.prevent="sendMessage">
                                <div class="flex rounded-md overflow-hidden border border-gray-300">
                                    <input v-model="message" type="text" class="flex-1 px-4 py-2 text-sm focus:online-none">

            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 tituloPagina">
                        <h1 class="h3">Atualize seu Negócio</h1>
                        <p>Preencha os campos abaixo para atualizar seu negócio.</p>
                    </div>
                    ...
                    <div class="col-md-12 conteudoPaginaCadastrarAnuncio">
                        ...
                        <form name="editarAnuncio" method="POST" action="{{ route('editar-anuncio') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                        ...
                                        <div class="personal-image">
                                            <label class="label">
                                                ...
                                                <figure class="personal-figure">
                                                    ...
                                                    @if (empty($anuncio->logotipo))
                                                        <img src="{{ asset('images/camera-white.png') }}" class="semLogotipo">
                                                    @endif
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input id="nome" type="text" class="form-control @error('nome') is-invalid @enderror" name="nome" value="{{ $anuncio->nome_da_empresa }}" required autocomplete="nome" autofocus>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="descricao" rows="6" class="form-control @error('descricao') is-invalid @enderror" name="descricao" required autocomplete="descricao" autofocus>{{ $anuncio->descricao }}</textarea>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="servicos" rows="6" class="form-control @error('servicos') is-invalid @enderror" name="servicos" required autocomplete="servicos" autofocus>{{ $anuncio->servicos }}</textarea>
                                        <span class="infoDetalhe">2000 caracteres</span>
                                    ...
                                    <div class="col-md-12 displayTable">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                @if ($anuncio->cpf == "")
                                                    <input id="cpfcnpj" type="text" class="form-control @error('cpfcnpj') is-invalid @enderror" name="cpfcnpj" value="{{ $anuncio->cnpj }}" onblur="capturarInputCpfCnpj(this.value)" required autocomplete="cpfcnpj" autofocus>
                                                @endif

                                                @if ($anuncio->cnpj == "")
                                                    <input id="cpfcnpj" type="text" class="form-control @error('cpfcnpj') is-invalid @enderror" name="cpfcnpj" value="{{ $anuncio->cpf }}" onblur="capturarInputCpfCnpj(this.value)" required autocomplete="cpfcnpj" autofocus>
                                                @endif
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input id="telefonePrincipal" type="tel" class="form-control @error('telefonePrincipal') is-invalid @enderror" value="{{ $anuncio->telefone_principal }}" name="telefonePrincipal" required autocomplete="telefonePrincipal" autofocus>
                                    ...
                                    <div class="col-md-12 displayTable">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <input id="telefoneAdicional" type="tel" class="form-control @error('telefoneAdicional') is-invalid @enderror" value="{{ $anuncio->telefone_adicional }}" name="telefoneAdicional" required autocomplete="telefoneAdicional" autofocus>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input id="endereco" type="text" class="form-control @error('endereco') is-invalid @enderror" value="{{ $anuncio->endereco }}" name="endereco" required autocomplete="endereco" autofocus>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input id="numeroResidencia" type="text" class="form-control @error('numeroResidencia') is-invalid @enderror" value="{{ $anuncio->numero }}" name="numeroResidencia" required autocomplete="numeroResidencia" autofocus>
                                    ...
                                    <div class="col-md-12 displayTable">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input id="complemento" type="text" class="form-control @error('complemento') is-invalid @enderror" value="{{ $anuncio->complemento }}" name="complemento" required autocomplete="complemento" autofocus>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input id="bairro" type="text" class="form-control @error('bairro') is-invalid @enderror" value="{{ $anuncio->bairro }}" name="bairro" required autocomplete="bairro" autofocus>
                                    ...
                                    <div class="col-md-12 displayTable">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <input id="cidade" type="text" class="form-control @error('cidade') is-invalid @enderror" value="{{ $anuncio->cidade }}" name="cidade" required autocomplete="cidade" autofocus>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input id="estado" type="text" class="form-control @error('estado') is-invalid @enderror" value="{{ $anuncio->estado }}" name="estado" required autocomplete="estado" autofocus>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input id="cep" type="text" class="form-control @error('cep') is-invalid @enderror" value="{{ $anuncio->cep }}" name="cep" required autocomplete="cep" autofocus>
                                    ...
                                    <button type="submit" class="btn btnPadrao float-right ajusteBtnPadrao">Atualizar Negócio</button>
